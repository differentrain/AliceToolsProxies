...
namespace AliceToolsProxies
{
    ...
    /// <para>Inherits <see cref="AliceFileOperation"/> class or <see cref="IAliceToolsOperation"/> interface to create a new 'operation' of alice-tools.</para>
    /// Inherits <see cref="AliceToolsOutputConverter{TOutput}"/> class to create converter for converting output string of alice-tools to another type.
    /// </remarks>
    public sealed class AliceToolsProxy : IDisposable
    {
        ...
        /// program will use relative path "alice.exe".
        /// </remarks>
